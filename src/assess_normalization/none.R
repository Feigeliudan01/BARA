...
# Prediction results for unnormalized data
...
saveRDS(object = svm_full, 
        file = 'results/assess_normalization/none/svm_full.RDS')
saveRDS(object = svm_small, 
        file = 'results/assess_normalization/none/svm_small.RDS')
saveRDS(object = rf_full, 
        file = 'results/assess_normalization/none/rf_full.RDS')
saveRDS(object = rf_small, 
        file = 'results/assess_normalization/none/rf_small.RDS')
saveRDS(object = knn_full, 
        file = 'results/assess_normalization/none/knn_full.RDS')
saveRDS(object = knn_small, 
        file = 'results/assess_normalization/none/knn_small.RDS')