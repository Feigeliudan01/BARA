...
normalization <- list(
  fit = function(x, ref, ...){
    ...
    fit <- bapred::fabatch(x = x, y = y, batch = batch)
    return(list(
      x_train = fit$xadj,
      fit = fit,
      ref = ref
  ...
  transform = function(fit, x_test, ref){
    ...
    res <- bapred::fabatchaddon(params = fit$fit, x = x_test, batch = batch)
...
saveRDS(object = svm_full, 
        file = 'results/assess_normalization/fabatch/svm_full.RDS')
saveRDS(object = svm_small, 
        file = 'results/assess_normalization/fabatch/svm_small.RDS')
saveRDS(object = rf_full, 
        file = 'results/assess_normalization/fabatch/rf_full.RDS')
saveRDS(object = rf_small, 
        file = 'results/assess_normalization/fabatch/rf_small.RDS')
saveRDS(object = knn_full, 
        file = 'results/assess_normalization/fabatch/knn_full.RDS')
saveRDS(object = knn_small, 
        file = 'results/assess_normalization/fabatch/knn_small.RDS')