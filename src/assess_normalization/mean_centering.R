...
# Prediction results for mean-centered data (bapred)
...
normalization <- list(
  fit = function(x, ref, ...){
    ...
    fit <- bapred::meancenter(x = x, batch = batch)
    return(list(
      x_train = fit$xadj,
      fit = fit,
      ref = ref
  ...
  transform = function(fit, x_test, ref){
    ...
    res <- bapred::meancenteraddon(params = fit$fit, x = x_test, batch = batch)
...
saveRDS(object = svm_full, 
        file = 'results/assess_normalization/mean_centering/svm_full.RDS')
saveRDS(object = svm_small, 
        file = 'results/assess_normalization/mean_centering/svm_small.RDS')
saveRDS(object = rf_full, 
        file = 'results/assess_normalization/mean_centering/rf_full.RDS')
saveRDS(object = rf_small, 
        file = 'results/assess_normalization/mean_centering/rf_small.RDS')
saveRDS(object = knn_full, 
        file = 'results/assess_normalization/mean_centering/knn_full.RDS')
saveRDS(object = knn_small, 
        file = 'results/assess_normalization/mean_centering/knn_small.RDS')