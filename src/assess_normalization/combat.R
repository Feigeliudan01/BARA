...
# Prediction results for combat (bapred)
...
normalization <- list(
  fit = function(x, ref, ...){
    ...
    fit <- bapred::combatba(x = x, batch = batch)
    return(list(
      x_train = fit$xadj,
      fit = fit,
      ref = ref
  ...
  transform = function(fit, x_test, ref){
    ...
    res <- bapred::combatbaaddon(params = fit$fit, x = x_test, batch = batch)
...
saveRDS(object = svm_full, 
        file = 'results/assess_normalization/combat/svm_full.RDS')
saveRDS(object = svm_small, 
        file = 'results/assess_normalization/combat/svm_small.RDS')
saveRDS(object = rf_full, 
        file = 'results/assess_normalization/combat/rf_full.RDS')
saveRDS(object = rf_small, 
        file = 'results/assess_normalization/combat/rf_small.RDS')
saveRDS(object = knn_full, 
        file = 'results/assess_normalization/combat/knn_full.RDS')
saveRDS(object = knn_small, 
        file = 'results/assess_normalization/combat/knn_small.RDS')