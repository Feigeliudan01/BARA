...
# Prediction results for reference ratio-A
...
normalization <- list(
  ...
  transform = function(fit, x_test, ref){
    x_test <- ref_ratioa(x = x_test, ref = ref)
...
saveRDS(object = svm_full, 
        file = 'results/assess_normalization/ref_ratio/svm_full.RDS')
saveRDS(object = svm_small, 
        file = 'results/assess_normalization/ref_ratio/svm_small.RDS')
saveRDS(object = rf_full, 
        file = 'results/assess_normalization/ref_ratio/rf_full.RDS')
saveRDS(object = rf_small, 
        file = 'results/assess_normalization/ref_ratio/rf_small.RDS')
saveRDS(object = knn_full, 
        file = 'results/assess_normalization/ref_ratio/knn_full.RDS')
saveRDS(object = knn_small, 
        file = 'results/assess_normalization/ref_ratio/knn_small.RDS')